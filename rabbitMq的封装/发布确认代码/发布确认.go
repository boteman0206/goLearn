...
func main() {
	...
	if err := chs.ExchangeDeclare("logs", "topic", true, false, false, false, nil); err != nil {
	...
	shovel, err := chs.Consume("remote-tee", "shovel", false,
	...
	destination, err := amqp.Dial(MQURL)
	if err != nil {
